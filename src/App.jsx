...
const principlesData = [
  ...
  { name: "相互利益", connects: ["リスペクト", "コミュニケーション"], practices: ["テスト駆動開発", "ペアプログラミング"] },
  ...
  { name: "機会", connects: ["勇気", "フィードバック"], practices: ["インクリメンタルな設計", "テスト駆動開発"] },
  { name: "冗長性", connects: ["コミュニケーション", "フィードバック"], practices: ["ペアプログラミング", "テスト駆動開発"] },
  { name: "失敗", connects: ["勇気", "フィードバック"], practices: ["テスト駆動開発", "継続的インテグレーション"] },
  { name: "品質", connects: ["シンプリシティ", "フィードバック"], practices: ["テスト駆動開発", "10分ビルド"] },
  { name: "ベイビーステップ", connects: ["シンプリシティ", "勇気"], practices: ["テスト駆動開発", "継続的インテグレーション"] },
  { name: "責任の引き受け", connects: ["リスペクト", "勇気"], practices: ["週次サイクル", "チーム全体"] },
];

const practicesData = [
  { name: "ペアプログラミング", icon: "pairProgramming", category: "team" },
  { name: "テスト駆動開発", icon: "tdd", category: "code" },
